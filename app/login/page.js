...
const LoginPage = () => {
    ...
    return (
        <div>
            <div className=' sm:border  flex flex-col sm:max-w-[400px] m-auto sm:my-14 min-h-[60vh] rounded-lg'>
                <h1 className='text-2xl font-bold text-center m-2'>Login to get started</h1>
                <div className='h-0.5 bg-black opacity-10 shadow shadow-black'></div>
                <div className='flex justify-center items-center flex-1'>
                    ...
                    <div className="flex flex-col gap-2 p-10">
                        <div>
                            ...
                            <p className='text-center text-red-500 '>For now only Github signin is working.</p>
                            <p className='text-center text-red-500 mb-3'> sorry for the inconvinience</p>
                        </div>
                        ...
                        <button
                            className=" opacity-60  flex items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
